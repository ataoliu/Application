...
namespace Application.Util
{
    ...
    public class JsonFileHelper
    {
        ...
        public JsonFileHelper(string jsonName)
        {
            ...
            _path = Root.Root.RootPath + _path;
        ...
        /// 读取节点下的值 暂不支持读数组
        /// </summary>
        /// <param name="section">节点名称 用:分割</param>
        /// <returns></returns>
            ...
            try
            {
                ...
                using (var reader = new JsonTextReader(file))
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(section))
                    {
                        ...
                        {
                            jObj = jObj[sections[i]] as JObject;
                        }

                        var secJt = jObj[sections[sections.Length - 1]];
                        if (secJt != null)
                        {
